                            ...
                            <Row>
                                <Col span={24}>
                                    <div className="title-container">
                                        <span className="text-soft-blue title-biggest bold">Hello Guys,i'm</span>
                                        <br/>
                                        <span className="text-soft-blue title-big bold">Geza Ramda Ciptaan</span>
                                    </div>
                                </Col>
                                <Col span={24}>
                                ...
                                <Modal
                                    ...
                                    >
                                    <p className="text-notif">Silakan email ke geza.r.c@mail.ugm.ac.id</p>
